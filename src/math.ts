...
export const { min, max, sqrt, sin, cos, asin, acos, PI, abs, floor, pow, round, log10, log, exp } = Math
export const minmax = ( val : number, lo : number, hi : number ) => min( hi, max( val, lo ) )
